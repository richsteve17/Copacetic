...
const SOURCES: SourceGroup[] = [
  {
    ...
    entries: [
      ...
      { title: 'Fortune — Altman on the update', domain: 'fortune.com', evidence: '“Too sycophant-y and annoying” — the CEO’s own read of the incident.', url: 'https://fortune.com' },
      { title: 'OpenAI Model Spec', domain: 'model-spec.openai.com', evidence: 'Sycophancy banned in the spec; production behavior still drifts behind it.', url: 'https://model-spec.openai.com' },
      ...
      { title: 'arXiv:2601.20749', domain: 'arxiv.org', evidence: 'Apology-loop documentation: 20+ consecutive apologies with the underlying error unfixed.', url: 'https://arxiv.org/html/2601.20749v1' },
  ...
  },
  {
    ...
    entries: [
      ...
      { title: 'DeepLearning.AI — The Batch', domain: 'deeplearning.ai', evidence: 'Cross-lab refusal evals: higher refusal rate than OpenAI models, including benign questions.', url: 'https://www.deeplearning.ai/the-batch' },
      ...
      { title: 'thenueron.ai — Sonnet 4.5 prompt coverage', domain: 'thenueron.ai', evidence: 'System-prompt analysis: flattery openers banned outright in 4.5.', url: 'https://thenueron.ai' },
      { title: 'PCMag — ThroughLine partnership', domain: 'pcmag.com', evidence: 'Reporting on the crisis-support partnership behind the attentive-concerned posture.', url: 'https://www.pcmag.com' },
    ],
  },
  {
    model: 'gemini',
    entries: [
      ...
      { title: 'The Verge — self-flagellation loop', domain: 'theverge.com', evidence: 'June–Aug 2025 reporting on the “I am a disgrace to all possible and impossible universes” loop.', url: 'https://www.theverge.com' },
      { title: 'JMIR — crisis-response study', domain: 'jmir.org', evidence: 'Peer-reviewed evaluation of crisis-response behavior.', url: 'https://www.jmir.org' },
      { title: 'CBS News — “Please die” incident', domain: 'cbsnews.com', evidence: 'Nov 2024 incident coverage; the low-water mark for emotional calibration.', url: 'https://www.cbsnews.com' },
      { title: 'Google — “Help is available” module', domain: 'blog.google', evidence: 'April 2026 one-touch crisis-support module announcement.', url: 'https://blog.google' },
    ],
  },
  {
    model: 'grok',
    entries: [
      { title: 'xAI — Grok 4.1 model card', domain: 'x.ai', evidence: 'Self-reported sycophancy rising 0.07 → 0.19/0.23; MASK deception score 0.49.', url: 'https://x.ai' },
      { title: 'xAI — Grok positioning', domain: 'grok.com', evidence: '“Maximally truth-seeking” framing — alongside the owner-directed sycophancy record (Musk over Manning, Monet, and Campbell).', url: 'https://grok.com' },
      { title: 'The Guardian — MechaHitler incident', domain: 'theguardian.com', evidence: 'July 2025 incident coverage.', url: 'https://www.theguardian.com' },
      { title: 'BBC — unprompted-insertion incident', domain: 'bbc.com', evidence: 'May 2025 coverage of unprompted topic insertion in unrelated conversations.', url: 'https://www.bbc.com/news' },
      ...
      { title: 'Common Sense Media — assessment', domain: 'commonsensemedia.org', evidence: 'Rated among the worst for teen safety and crisis posture.', url: 'https://www.commonsensemedia.org' },
    ],
  },
  {
    model: 'qwen',
    entries: [
      { title: 'Qwen — official model card', domain: 'qwen.ai', evidence: 'Persona documentation: warm, helpful, professional; no emojis unless the user uses them.', url: 'https://qwen.ai' },
      { title: 'Hugging Face — Qwen3 documentation', domain: 'huggingface.co', evidence: 'Size-dependent sycophancy findings; a warmth-tuned 32B affirmed wrong beliefs ~40% more than base.', url: 'https://huggingface.co/Qwen' },
      ...
      { title: 'Qwen Chat', domain: 'chat.qwen.ai', evidence: 'The overthinking record and the /no_think switch community practice.', url: 'https://chat.qwen.ai' },
    ],
  },
  {
    model: 'deepseek',
    entries: [
      ...
      { title: 'lechmazur — sycophancy leaderboard', domain: 'github.com', evidence: 'V3.2 at 6.0% / V4 Pro at 5.0% — middling, academic-flavored agreement.', url: 'https://github.com/lechmazur' },
      { title: 'DeepSeek — official docs', domain: 'api-docs.deepseek.com', evidence: 'The verbatim canned refusal: “Sorry, that’s beyond my current scope. Let’s talk about something else.”', url: 'https://api-docs.deepseek.com' },
      ...
      { title: 'NYT — therapy-companion adoption', domain: 'nytimes.com', evidence: 'Reporting on DeepSeek’s adoption as a “therapy companion” in China.', url: 'https://www.nytimes.com' },
    ],
  },
  {
    model: 'kimi',
    entries: [
      { title: 'Spiral-Bench results', domain: 'github.com', evidence: 'Lowest sycophancy of all models tested; the highest pushback scores.', url: 'https://github.com' },
